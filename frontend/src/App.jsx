...
export default function App() {
  ...
  async function handleSearch(e) {
    ...
    setLoading(true);
    setError(null);
    // Local dev uses your machine + backend/data/cache.json. Production uses Vercel backend unless VITE_API_BASE is set.
    const API_BASE =
      import.meta.env.VITE_API_BASE ||
      (import.meta.env.DEV
        ? "http://localhost:8080"
        : "https://purdue-ece-faculty-directory-backen.vercel.app");
    const q = query.trim();
